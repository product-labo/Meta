...
describe('Dashboard Simplification Property Tests', () => {
  ...
  describe('Property 1: Direct Table Display', () => {
    test('Dashboard page should render ProjectsTable directly without tabs', () => {
      ...
      const dashboardPath = path.join(__dirname, '../../fip/app/dashboard/page.tsx');
  ...
  describe('Property 4: Layout Structure Preservation', () => {
    ...
    test('Dashboard layout should work with sidebar integration', () => {
      const layoutPath = path.join(__dirname, '../../fip/app/dashboard/layout.tsx');
      ...
      expect(layoutContent).toContain('DashboardContext.Provider');
    });
  });
  ...
  describe('Integration Validation', () => {
    test('Required component files should exist', () => {
      ...
      const componentsToCheck = [
        '../../fip/components/dashboard/header.tsx',
        '../../fip/components/dashboard/projects-table.tsx',
        '../../fip/components/ui/badge.tsx'
      ];
    ...
    test('WebSocket hook should exist', () => {
      const hookPath = path.join(__dirname, '../../fip/hooks/use-websocket.tsx');
      const altHookPath = path.join(__dirname, '../../fip/hooks/use-websocket.ts');
