...
export default function OnboardingPage() {
  ...
  const onSubmit = async (data: OnboardingFormData) => {
    try {
      ...
      if (response.indexingStarted) {
        setIsIndexing(true);
        setStep(4); // Move to indexing step
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">Welcome to Contract Analytics</h1>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  {indexingProgress === 100 ? 'Setup Complete!' : 'Indexing Your Contract'}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="text-center">
                  <p className="text-muted-foreground mb-4">
                    {indexingProgress === 100 
                      ? 'Your contract has been successfully indexed and analyzed!'
                      : 'We\'re analyzing your contract and gathering historical data. This may take a few minutes.'
                    }
                  </p>
                ...
                <div className="bg-muted p-4 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>• Fetching contract interactions and events</li>
                    <li>• Analyzing transaction patterns and user behavior</li>
                    <li>• Calculating DeFi metrics and performance indicators</li>
