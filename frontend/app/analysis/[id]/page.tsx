          ...
          <Tabs defaultValue="overview" className="space-y-4">
              ...
              <Card>
                ...
                <CardContent>
                  <pre className="text-sm bg-muted p-4 rounded-lg overflow-auto">
                    {JSON.stringify(analysis.results.overview, null, 2)}
                  </pre>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="transactions">
              <Card>
                ...
                <CardContent>
                  <pre className="text-sm bg-muted p-4 rounded-lg overflow-auto">
                    {JSON.stringify(analysis.results.transactions, null, 2)}
                  </pre>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="users">
              <Card>
                ...
                <CardContent>
                  <pre className="text-sm bg-muted p-4 rounded-lg overflow-auto">
                    {JSON.stringify(analysis.results.users, null, 2)}
                  </pre>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="competitive">
              <Card>
                ...
                <CardContent>
                  <pre className="text-sm bg-muted p-4 rounded-lg overflow-auto">
                    {JSON.stringify(analysis.results.competitive, null, 2)}
                  </pre>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="ai-insights">
              <Card>
                ...
                <CardContent>
                  <pre className="text-sm bg-muted p-4 rounded-lg overflow-auto">
                    {JSON.stringify(analysis.results.aiInsights, null, 2)}
                  </pre>
                </CardContent>
              </Card>
            </TabsContent>
