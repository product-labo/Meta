        ...
        <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-8">
            <div className="space-y-3">
              <Label htmlFor="dapp-url" className="text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">DApp URL</Label>
              <Input id="dapp-url" placeholder="https://metaguage.com" className="h-12 bg-white border-gray-200 rounded-xl px-4 text-sm" />
            </div>
            <div className="space-y-3">
              <Label htmlFor="github" className="text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">GitHub(if open source</Label>
