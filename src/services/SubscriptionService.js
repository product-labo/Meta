...
class SubscriptionService {
  ...
  async isSubscriberActive(walletAddress) {
    try {
      ...
      const isActive = await this.subscriptionContract.isSubscriberActive(walletAddress);
      return isActive;
    } catch (error) {
  ...
  async getSubscriptionInfo(walletAddress) {
    try {
      ...
      const subInfo = await this.subscriptionContract.getSubscriptionInfo(walletAddress);
